  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      >
        ...
        <Link
          to="http://localhost:3000/dashboard/createUniversity"
      ...
      <Grid container spacing={3}>
        {universities.map((university) => (
          <Grid key={university.id} item xs={12} sm={6} md={4}>
            <Card elevation={3}>
              <Link
                to={`http://localhost:3000/dashboard/universities/detailsUni/${university.universityId}`}
                style={{
                  textDecoration: "none",
                  color: "inherit",
                  cursor: "pointer",
              ...
              >
                ...
                >
                  <Link
                    to={`http://localhost:3000/dashboard/universities/depUni/${university.universityId}`}
                  >
                    <Button
                      variant="contained"
                      color="primary"
                  ...
                  {/* This will push the dropdown menu to the right */}
                  <IconButton
